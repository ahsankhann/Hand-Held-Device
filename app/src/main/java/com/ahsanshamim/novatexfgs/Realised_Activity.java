...
public class Realised_Activity extends AppCompatActivity {
    private EditText mResultText, BarcodeResult, txtHold;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_realised_);
    ...
    private void SelectType(){
        final String[] Values = {"Released"};
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Select Hold Or Released");
        builder.setSingleChoiceItems(Values, -1, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                txtHold.setText(Values[which]);
                if(txtHold.getText().toString().equals("Hold") || txtHold.getText().toString().equals("PBST")|| txtHold.getText().toString().equals("Manual Sorting")|| txtHold.getText().toString().equals("Released Cartons")) {
                    SetBarcode();
                }
                alertDialog.dismiss();
            }
    ...
    protected void onResume() {
        if(txtHold.getText().toString().equals("Hold") || txtHold.getText().toString().equals("Released Cartons")|| txtHold.getText().toString().equals("PBST")|| txtHold.getText().toString().equals("Manual Sorting")) {
            SetBarcode();
        }
        super.onResume();
    }
    ...
    {
        setTitle("Released Carton Scanning");
...
//                refreshButton();
    ...
    private void setResulsText(String Json){
        ...
        /*if(txtHold.getText().toString().equals("Hold") || txtHold.getText().toString().equals("PBST")|| txtHold.getText().toString().equals("Manual Sorting")){
            try{
                if(Json != null && Json != "") {
                    ...
                    if(Split.length == 11) {
                        ...
                        try {
                            ...
                            if (txtHold.getText().toString().equals("Hold"))
                                json.put("hold", "H");
                            else if (txtHold.getText().toString().equals("PBST"))
                                json.put("hold", "P");
        ...
        /*else if(txtHold.getText().toString().equals("Realised Cartons")){*/
            try{
                if(Json != null && Json != "") {
                    //BagInfo JsonBag = new Gson().fromJson(String.valueOf(Json), BagInfo.class);
                    ...
                    JsonObjectRequest request = new JsonObjectRequest(
                            ...
                            new Response.ErrorListener() {
                                @Override
                                public void onErrorResponse(VolleyError error) {
                                    ErrorInResponse("Connecting Server TimeOut Error", "Connecting Server TimeOut");
                                }
                            }
                    );
                    requestQueue.add(request);
...
//        }
    ...
    private void ErrorInResponse(String ErrorToast, String ErrorAlert){
        ...
        txtStatus.setText("Please Contact Mr. Ahsan IS Department");
