...
public class MoldingScanner_Activity extends AppCompatActivity
{
    private EditText mResultText, BarcodeResult;
    private String mStatusText;
    private String mSuccessFailText;
    private ProgressDialog mProgressDialog, mProgressDialogScan;
    ...
    TextView Grammagelbl, ColorShadelbl,ProductCodelbl, Gradelbl, NeckTypelbl, BatchNolbl, TareWeightlbl, GrossWeightlbl, NetWeightlbl, Pieceslbl, Mobilelbl;
    TextView Grammagelbl1, ColorShadelbl1,ProductCodelbl1, Gradelbl1, NeckTypelbl1, BatchNolbl1, TareWeightlbl1, GrossWeightlbl1, NetWeightlbl1, Pieceslbl1, Mobilelbl1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_molding_scanner_);
...
//                refreshButton();
    ...
    private void setResulsText(String Json){
        ...
        if(Json != null && Json != "") {
            ...
            if (Split.length == 11) {
                ...
                ErrorInResponse("QR Code Error", "Invalid QR Code");
            }
                ...
                JsonObjectRequest request = new JsonObjectRequest(
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                showProgressDialogScan(false);
                                ErrorInResponse("Connecting Server TimeOut Error", "Connecting Server");
                            }
                        }
                );
    ...
    private void Gonetxt(){
        /*Grammagelbl1.setVisibility(View.GONE);
        ColorShadelbl1.setVisibility(View.GONE);
        ProductCodelbl1.setVisibility(View.GONE);
        Gradelbl1.setVisibility(View.GONE);
        NeckTypelbl1.setVisibility(View.GONE);
        BatchNolbl1.setVisibility(View.GONE);
        TareWeightlbl1.setVisibility(View.GONE);
        GrossWeightlbl1.setVisibility(View.GONE);
        NetWeightlbl1.setVisibility(View.GONE);
        Pieceslbl1.setVisibility(View.GONE);
        Mobilelbl1.setVisibility(View.GONE);

        Grammagelbl.setVisibility(View.GONE);
        ColorShadelbl.setVisibility(View.GONE);
        ProductCodelbl.setVisibility(View.GONE);
        Gradelbl.setVisibility(View.GONE);
        NeckTypelbl.setVisibility(View.GONE);
        BatchNolbl.setVisibility(View.GONE);
        TareWeightlbl.setVisibility(View.GONE);
        GrossWeightlbl.setVisibility(View.GONE);
        NetWeightlbl.setVisibility(View.GONE);
        Pieceslbl.setVisibility(View.GONE);
        Mobilelbl.setVisibility(View.GONE);*/
    }

    private void Showntxt(){

        /*Grammagelbl1.setVisibility(View.VISIBLE);
        ColorShadelbl1.setVisibility(View.VISIBLE);
        ProductCodelbl1.setVisibility(View.VISIBLE);
        Gradelbl1.setVisibility(View.VISIBLE);
        NeckTypelbl1.setVisibility(View.VISIBLE);
        BatchNolbl1.setVisibility(View.VISIBLE);
        TareWeightlbl1.setVisibility(View.VISIBLE);
        GrossWeightlbl1.setVisibility(View.VISIBLE);
        NetWeightlbl1.setVisibility(View.VISIBLE);
        Pieceslbl1.setVisibility(View.VISIBLE);
        Mobilelbl1.setVisibility(View.VISIBLE);


        Grammagelbl.setVisibility(View.VISIBLE);
        ColorShadelbl.setVisibility(View.VISIBLE);
        ProductCodelbl.setVisibility(View.VISIBLE);
        Gradelbl.setVisibility(View.VISIBLE);
        NeckTypelbl.setVisibility(View.VISIBLE);
        BatchNolbl.setVisibility(View.VISIBLE);
        TareWeightlbl.setVisibility(View.VISIBLE);
        GrossWeightlbl.setVisibility(View.VISIBLE);
        NetWeightlbl.setVisibility(View.VISIBLE);
        Pieceslbl.setVisibility(View.VISIBLE);
        Mobilelbl.setVisibility(View.VISIBLE);*/
    }
...
//		getMenuInflater().inflate(R.menu.main, menu);
    ...
    private void destroyEvent()
    {
        ...
        if(mProgressDialogScan!=null) mProgressDialogScan.dismiss();
        mProgressDialogScan = null;
        unregisterReceiver();
        stopProgressTimer();
    }
    ...
    private void startProgressTimerScan()
    {
        mTimer = new Timer();
        mTimer.schedule(
                new TimerTask() {
                    @Override
                    public void run() {
                        if(mProgressDialogScan!=null && mProgressDialogScan.isShowing())
                        {
    ...
    private void stopProgressTimerScan()
    {
        if(mTimer != null)
        {
            mTimer.cancel();
    ...
    private void showProgressDialogScan(boolean isShow)
    {
        if(mProgressDialogScan == null)
        {
            mProgressDialogScan = new ProgressDialog(this);
            mProgressDialogScan.setTitle("Synchronize Server");
            mProgressDialogScan.setMessage("Please Wait. Transfer Records...");
            mProgressDialogScan.setCancelable(false);
        }

        stopProgressTimerScan();
        if(isShow)
        {
            mProgressDialogScan.show();
            startProgressTimerScan();
        }
        else mProgressDialogScan.dismiss();
    }

    private void LogReport(String Error){
        DatabaseHelper db = new DatabaseHelper(MoldingScanner_Activity.this);
        boolean result = db.InsertError("Scanning Activity - " + Error);
        if(result)
