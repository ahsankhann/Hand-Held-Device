...
public class Damage_Activity extends AppCompatActivity {

    private EditText mResultText, BarcodeResult, txtHold;
    private String mStatusText;
    private String mSuccessFailText;
    private ProgressDialog mProgressDialog;
    String Url = "http://192.168.96.148:8080/api/Damage/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_damage_);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        initialize();
        tb.setVisibility(View.GONE);
        txtCutton.setVisibility(View.GONE);
        GetDeviceData();
        txtHold.setEnabled(false);
    }
    ...
    {
        setTitle("Damage Carton Scanning");
...
//            Gradelbl.setText(JsonBag.Grade);
            ...
            if(txtStatus.getText().toString().equals("Carton Damage Successfully TAG")){
...
//		getMenuInflater().inflate(R.menu.main, menu);
    ...
    private void LogReport(String Error){
        DatabaseHelper db = new DatabaseHelper(Damage_Activity.this);
        boolean result = db.InsertError("Damage Carton Activity - " + Error);
        if(result)
